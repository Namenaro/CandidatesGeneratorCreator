from settings import DELINEATION_LINEWIDTH
import matplotlib
...
if __name__ == "__main__":
    from settings import LEADS_NAMES, POINTS_TYPES, POINTS_TYPES_COLORS
    from dataset_forms.LUDB_utils import get_some_test_patient_id,  get_one_lead_delineation_by_patient_id, get_signal_by_id_and_lead_mV, get_LUDB_data
